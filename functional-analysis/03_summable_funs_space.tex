...
$g,f \in \calL^p, f \sim g \Leftrightarrow f - g \in N \Leftrightarrow f(x) = g(x)$ почти всюду по $\mu$. $\overline{f}$~--- класс эквивалентности, $\overline{f} = \{g: f \sim g \}.$ \\
...
Одна из главных целей~--- доказать, что эти пространства Банаховы. Сначала определим $\calL^\infty(X, \mu)$ (существенно ограниченные функции).
...
Возьмём точную нижнюю грань этой константы. $||f||_\infty = \inf \{c \geq 0: \mu \{x: |f(x)| > c \}   = 0 \}$ (существенный $\sup$, или на подлом англосаксонском
ess $\sup_X f$) 

\begin{property}
\label{chap3:prop}
$f \in \calL^\infty(X, \mu) \Rightarrow \mu \{ x: \abs{f(x)} > ||f||_\infty \} = 0$
\end{property}
