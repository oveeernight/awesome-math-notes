...
\begin{example}[оператор, но не линейный]
...
\begin{proof}
    ...
    \begin{gather*}
        ...
        \norm{Af}_{p_1} = \norm{f}_{p_1} = \left( \int_X |f|^{p_1} d\mu \right)^{\frac{1}{p_1}} \stackrel{\text{н. Гёльдера}}{\leq} \left[ \left( \int_X |f|^{p_2} d\mu\right)^{\frac{1}{p}} \left( \int_X \mathbb{1}^q d\mu \right)^{\frac{1}{q}} \right]^{\frac{1}{p_1}} = \\ %цвет нужен
